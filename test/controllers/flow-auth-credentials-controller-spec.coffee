  ...
  describe '->show', ->
    ...
    describe 'when called with uuid and token', ->
      beforeEach ->
        ...
        @sut.getAccessToken.yields null, token: '1234', expiresOn: 1203510235, refreshToken: 'abc123'
        @request  =
          params:
            id: 'fastball'
          query:
      ...
      it 'should return an access_token', ->
        expect(@response.send).to.have.been.calledWith access_token: '1234', expiresOn: 1203510235, refreshToken: 'abc123'

    describe 'when called with another uuid and token', ->
      beforeEach ->
        @sut.verifyDevice.yields null, owner: 'mom'
        @sut.getAccessToken.yields null, token: '51234', expiresOn: 19599559, refreshToken: '1595959'
        @request  =
          params:
            id: 'coke'
          query:
      ...
      it 'should return an access_token', ->
        expect(@response.send).to.have.been.calledWith access_token: '51234', expiresOn: 19599559, refreshToken: '1595959'
